...
const COMPLEX_BLOCK_MESSAGE: &'static str = "in an 'if' condition, avoid complex blocks or \
                                             closures with blocks; instead, move the block or \
                                             closure higher and bind it with a 'let'";
