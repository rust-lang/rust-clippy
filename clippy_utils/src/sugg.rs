...
use crate::source::{SpanRangeExt, snippet, snippet_with_applicability, snippet_with_context};
...
impl<'a> Sugg<'a> {
    ...
    pub fn hir_opt(cx: &LateContext<'_>, expr: &hir::Expr<'_>) -> Option<Self> {
        ...
        (expr.span.get_source_text(cx)).map(|_| Self::hir_from_snippet(expr, get_snippet))
    }
