...
pub const FMT_DISPLAY: [&str; 3] = ["core", "fmt", "Display"];
pub const FMT_WRITE: [&str; 3] = ["core", "fmt", "Write"];
...
pub const IO_BUFREAD: [&str; 3] = ["std", "io", "BufRead"];
pub const IO_READ: [&str; 3] = ["std", "io", "Read"];
pub const IO_SEEK: [&str; 3] = ["std", "io", "Seek"];
