...
fn main() {
    ...
    let _secs_f64_2 = (dur.subsec_millis() as f32 + 1_000.0 * dur.as_secs() as f32) / 1000.0;
    let _secs_f64_3 = dur.as_secs() as f64 + dur.subsec_millis() as f64 / 1_000.0;
    let _secs_f64_5 = dur.as_secs() as f64 + dur.subsec_nanos() as f64 / 1_000_000_000.0;
