...
fn main() {
    ...
    let _ = a * b + c; //~ suboptimal_flops
    let _ = a * b - c; //~ suboptimal_flops
    let _ = c + a * b; //~ suboptimal_flops
    let _ = c - a * b; //~ suboptimal_flops
    let _ = a + 2.0 * 4.0; //~ suboptimal_flops
    let _ = a + 2. * 4.; //~ suboptimal_flops

    let _ = (a * b) + c; //~ suboptimal_flops
    let _ = c + (a * b); //~ suboptimal_flops
    let _ = a * b * c + d; //~ suboptimal_flops
    ...
    let _ = (a * a + b).sqrt(); //~ suboptimal_flops

    let u = 1usize;
    let _ = a - (b * u as f64); //~ suboptimal_flops
