...
fn main() {
    ...
    const BAD32_1: f32 = 0.123_456_789_f32; //~ excessive_precision
    const BAD32_2: f32 = 0.123_456_789; //~ excessive_precision
    const BAD32_3: f32 = 0.100_000_000_000_1;
    //~^ excessive_precision
    const BAD32_EDGE: f32 = 1.000_000_9; //~ excessive_precision
    ...
    let bad32: f32 = 1.123_456_789; //~ excessive_precision
    let bad32_suf: f32 = 1.123_456_789_f32; //~ excessive_precision
    let bad32_inf = 1.123_456_789_f32; //~ excessive_precision
    ...
    // issue #7745
    let _ = 1.000_000_000_000_001e-324_f64; //~ excessive_precision
