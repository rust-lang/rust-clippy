...
fn main() {
    ...
    assert_eq!("a".len(), 1);
    assert_eq!("a".is_empty(), false); //~ bool_assert_comparison
    assert_eq!("".is_empty(), true); //~ bool_assert_comparison
    assert_eq!(true, "".is_empty()); //~ bool_assert_comparison
    assert_eq!(a!(), b!());
    assert_eq!(a!(), "".is_empty());
    assert_eq!("".is_empty(), b!());
    assert_eq!(a, true);
    assert_eq!(b, true); //~ bool_assert_comparison

    assert_ne!("a".len(), 1);
    assert_ne!("a".is_empty(), false); //~ bool_assert_comparison
    assert_ne!("".is_empty(), true); //~ bool_assert_comparison
    assert_ne!(true, "".is_empty()); //~ bool_assert_comparison
    assert_ne!(a!(), b!());
    assert_ne!(a!(), "".is_empty());
    assert_ne!("".is_empty(), b!());
    assert_ne!(a, true);
    assert_ne!(b, true); //~ bool_assert_comparison
    ...
    debug_assert_eq!(b, true); //~ bool_assert_comparison
    ...
    debug_assert_ne!(b, true); //~ bool_assert_comparison
    ...
    assert_eq!(a!(), true); //~ bool_assert_comparison
    assert_eq!(true, b!()); //~ bool_assert_comparison

    use debug_assert_eq as renamed;
    renamed!(a, true);
    renamed!(b, true); //~ bool_assert_comparison
    ...
    assert_eq!("".is_empty(), true); //~ bool_assert_comparison
    assert_ne!("".is_empty(), false); //~ bool_assert_comparison
