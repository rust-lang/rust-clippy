...
fn main() {
    // Method calls
    let _ = "".to_string(); //~ manual_string_new
    let _ = "no warning".to_string();

    let _ = "".to_owned(); //~ manual_string_new
    let _ = "no warning".to_owned();

    let _: String = "".into(); //~ manual_string_new
    ...
    let _: String = From::from(""); //~ manual_string_new
