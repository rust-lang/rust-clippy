...
fn main() {
    ...
    //~^ unnecessary_lazy_evaluations
    let _ = opt.or_else(|| None); //~ unnecessary_lazy_evaluations
    let _ = opt.get_or_insert_with(|| 2);
    //~^ unnecessary_lazy_evaluations
    let _ = opt.ok_or_else(|| 2); //~ unnecessary_lazy_evaluations
    let _ = nested_tuple_opt.unwrap_or_else(|| Some((1, 2)));
    //~^ unnecessary_lazy_evaluations
    let _ = cond.then(|| astronomers_pi);
    //~^ unnecessary_lazy_evaluations
    let _ = true.then(|| -> _ {}); //~ unnecessary_lazy_evaluations
    let _ = true.then(|| {}); //~ unnecessary_lazy_evaluations
    ...
    //~v unnecessary_lazy_evaluations
