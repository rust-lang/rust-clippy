...
fn main() {
...

    {
        ...
        deref_target_is_x(&X); //~ needless_borrows_for_generic_args
    }
    {
    ...
    // https://github.com/rust-lang/rust-clippy/pull/9136#pullrequestreview-1037379321
    {
        ...
        fn warn(mut x: &mut Iter) {
            takes_iter(&mut x) //~ needless_borrows_for_generic_args
        }
    }
    #[clippy::msrv = "1.52.0"]
    {
    ...
    }
    {
        ...
        let x = String::new();
        f(&x); //~ needless_borrows_for_generic_args
    }
    {
        fn f(_: impl AsRef<str>) {}
    ...
    // issue 9782
    {
        ...
        // 8
        foo::<&[u8; 100]>(&a);
        foo(&a); //~ needless_borrows_for_generic_args
    }
    {
        struct S;
