...
fn main() {
    ...
    a.i = 42; //~ field_reassign_with_default
    ...
    let mut a: A = Default::default();
    a.j = 43; //~ field_reassign_with_default
    a.i = 42;
    ...
    let mut a: A = Default::default();
    a.i = Default::default(); //~ field_reassign_with_default
    ...
    a.i = vec![1]; //~ field_reassign_with_default
    ...
    a.i = true; //~ field_reassign_with_default
...
mod issue6312 {
    ...
    impl ImplDropAllCopy {
        fn new(name: &str) -> Self {
            ...
            f.name = name.len(); //~ field_reassign_with_default
            f
        }
        fn close(&self) {}
    }
