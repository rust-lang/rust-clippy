...
fn main() {
    ...
    let _ = write!(
        ...
        Location::caller().to_string() //~ to_string_in_format_args
    );
    let _ = writeln!(
        stdout(),
        "error: something failed at {}",
    ...
    //~^ to_string_in_format_args
    println!("{}", X(1).to_string()); //~ to_string_in_format_args
    println!("{}", Y(&X(1)).to_string());
    //~^ to_string_in_format_args
    println!("{}", Z(1).to_string()); //~ to_string_in_format_args
    println!("{}", x.to_string()); //~ to_string_in_format_args
    println!("{}", x_ref.to_string()); //~ to_string_in_format_args
