...
fn main() {
    ...
    let _ = i8::BITS - w.leading_zeros(); //~ manual_bit_width
    let w: u16 = 5;
    let _ = u16::BITS - w.leading_zeros(); //~ manual_bit_width
    let _ = i16::BITS - w.leading_zeros(); //~ manual_bit_width
    let w: u32 = 5;
    let _ = u32::BITS - w.leading_zeros(); //~ manual_bit_width
    let _ = NonZeroU32::BITS - w.leading_zeros(); //~ manual_bit_width
    let w: u64 = 5;
    let _ = u64::BITS - w.leading_zeros(); //~ manual_bit_width
    let _ = NonZero::<i64>::BITS - w.leading_zeros(); //~ manual_bit_width
    let w: usize = 5;
    let _ = usize::BITS - w.leading_zeros(); //~ manual_bit_width
    let _ = isize::BITS - w.leading_zeros(); //~ manual_bit_width
    // signed
    let x: i8 = -5;
    ...
    let _ = NonZeroI32::BITS - x.leading_zeros(); //~ manual_bit_width
    let x: i64 = -5;
    ...
    let _ = u8::BITS - y.leading_zeros(); //~ manual_bit_width
    let y = NonZero::<u16>::new(5).unwrap();
    let _ = NonZero::<u16>::BITS - y.leading_zeros(); //~ manual_bit_width
    let _ = i16::BITS - y.leading_zeros(); //~ manual_bit_width
