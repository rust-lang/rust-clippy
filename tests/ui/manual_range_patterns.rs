...
fn main() {
    ...
    let _ = matches!(f, 1 | (2..=4)); //~ manual_range_patterns
    let _ = matches!(f, 1 | (2..4)); //~ manual_range_patterns
    ...
    matches!(f, 0..5 | 5); //~ manual_range_patterns
    matches!(f, 0 | 1..5); //~ manual_range_patterns

    matches!(f, 0..=5 | 6..10); //~ manual_range_patterns
    matches!(f, 0..5 | 5..=10); //~ manual_range_patterns
    matches!(f, 5..=10 | 0..5); //~ manual_range_patterns
