...
fn unwrap_option_some() {
    let _val = Some(1).unwrap(); //~ unnecessary_literal_unwrap
    let _val = Some(1).expect("this never happens");
    //~^ unnecessary_literal_unwrap

    Some(1).unwrap(); //~ unnecessary_literal_unwrap
...
fn unwrap_option_none() {
    let _val = None::<()>.unwrap(); //~ unnecessary_literal_unwrap
    ...
    None::<()>.unwrap(); //~ unnecessary_literal_unwrap
    None::<()>.expect("this always happens");
    //~^ unnecessary_literal_unwrap
    None::<String>.unwrap_or_default();
    //~^ unnecessary_literal_unwrap
    None::<u16>.unwrap_or(234); //~ unnecessary_literal_unwrap
...
fn unwrap_result_ok() {
    ...
    Ok::<_, ()>(1).unwrap(); //~ unnecessary_literal_unwrap
    Ok::<_, ()>(1).expect("this never happens");
    //~^ unnecessary_literal_unwrap
    Ok::<_, ()>(1).unwrap_err(); //~ unnecessary_literal_unwrap
...
fn unwrap_result_err() {
    ...
    Err::<(), _>(1).unwrap_err(); //~ unnecessary_literal_unwrap
    Err::<(), _>(1).expect_err("this never happens");
    //~^ unnecessary_literal_unwrap
    Err::<(), _>(1).unwrap(); //~ unnecessary_literal_unwrap
    Err::<(), _>(1).expect("this always happens");
    //~^ unnecessary_literal_unwrap
}

fn unwrap_methods_option() {
    let _val = Some(1).unwrap_or(2); //~ unnecessary_literal_unwrap
    ...
    Some(1).unwrap_or_default(); //~ unnecessary_literal_unwrap
    Some(1).unwrap_or_else(|| 2); //~ unnecessary_literal_unwrap
}
