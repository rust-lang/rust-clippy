...
fn main() {
    ...
    // Test padding
    let _ = 0x100000; //~ unreadable_literal
    let _ = 0x1000000; //~ unreadable_literal
    let _ = 0x10000000; //~ unreadable_literal
    let _ = 0x100000000_u64; //~ unreadable_literal

    // Test suggestion when fraction has no digits
    let _: f32 = 1_23_456.; //~ inconsistent_digit_grouping
