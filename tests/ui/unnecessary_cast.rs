...
fn owo<T>(ptr: *const T) -> *const T {
    ptr as *const T //~ unnecessary_cast
}
...
fn main() {
    ...
    1i32 as i32; //~ unnecessary_cast
    1f32 as f32; //~ unnecessary_cast
    false as bool; //~ unnecessary_cast
    &1i32 as &i32;

    -1_i32 as i32; //~ unnecessary_cast
    - 1_i32 as i32; //~ unnecessary_cast
    -1f32 as f32; //~ unnecessary_cast
    1_i32 as i32; //~ unnecessary_cast
    1_f32 as f32; //~ unnecessary_cast

    let _: *mut u8 = [1u8, 2].as_ptr() as *const u8 as *mut u8;
    //~^ unnecessary_cast

    [1u8, 2].as_ptr() as *const u8; //~ unnecessary_cast
    [1u8, 2].as_ptr() as *mut u8;
    [1u8, 2].as_mut_ptr() as *mut u8; //~ unnecessary_cast
    ...
    owo::<u32>([1u32].as_ptr()) as *const u32; //~ unnecessary_cast
...
mod fixable {
    ...
    fn main() {
        ...
        100 as f32; //~ unnecessary_cast
        100 as f64; //~ unnecessary_cast
        100_i32 as f64; //~ unnecessary_cast
        let _ = -100 as f32; //~ unnecessary_cast
        let _ = -100 as f64; //~ unnecessary_cast
        let _ = -100_i32 as f64; //~ unnecessary_cast
        100. as f32; //~ unnecessary_cast
        100. as f64; //~ unnecessary_cast
        // Should not trigger
        #[rustfmt::skip]
        ...
        1 as u32; //~ unnecessary_cast
        0x10 as i32; //~ unnecessary_cast
        0b10 as usize; //~ unnecessary_cast
        0o73 as u16; //~ unnecessary_cast
        1_000_000_000 as u32; //~ unnecessary_cast

        1.0 as f64; //~ unnecessary_cast
        0.5 as f32; //~ unnecessary_cast

        1.0 as u16;

        let _ = -1 as i32; //~ unnecessary_cast
        let _ = -1.0 as f32; //~ unnecessary_cast

        let _ = 1 as I32Alias;
        let _ = &1 as &I32Alias;

        let x = 1i32;
        let _ = &(x as i32); //~ unnecessary_cast
    }

    type I32Alias = i32;

    fn issue_9380() {
        let _: i32 = -(1) as i32; //~ unnecessary_cast
        let _: f32 = -(1) as f32;
        let _: i64 = -(1) as i64; //~ unnecessary_cast
    ...
    fn issue_9563() {
        let _: f64 = (-8.0 as f64).exp(); //~ unnecessary_cast
    ...
    fn issue_9562_non_literal() {
        ...
        let _num = foo() as f32; //~ unnecessary_cast
    }
