...
fn main() {
    // yay
    let _ = [1].iter().cloned(); //~ cloned_instead_of_copied
    let _ = vec!["hi"].iter().cloned(); //~ cloned_instead_of_copied
    let _ = Some(&1).cloned(); //~ cloned_instead_of_copied
