...
#[allow(dead_code)] //~ allow_attributes_without_reason
#[allow(dead_code, deprecated)] //~ allow_attributes_without_reason
#[expect(dead_code)] //~ allow_attributes_without_reason
