...
fn main() {
    ...
    let _ = ptr as *const i32; //~ ptr_as_ptr
    let _ = mut_ptr as *mut i32; //~ ptr_as_ptr

    // Make sure the lint can handle the difference in their operator precedences.
    unsafe {
        let ptr_ptr: *const *const u32 = &ptr;
        let _ = *ptr_ptr as *const i32; //~ ptr_as_ptr
    }
    ...
    let _: *const i32 = ptr as *const _; //~ ptr_as_ptr
    let _: *mut i32 = mut_ptr as _; //~ ptr_as_ptr

    // Make sure the lint is triggered inside a macro
    let _ = inline!($ptr as *const i32); //~ ptr_as_ptr
...
mod null {
    fn use_path_mut() -> *mut u32 {
        use std::ptr;
        ptr::null_mut() as *mut u32 //~ ptr_as_ptr
    }

    fn full_path_mut() -> *mut u32 {
        std::ptr::null_mut() as *mut u32 //~ ptr_as_ptr
    }
    ...
    fn full_core_path_mut() -> *mut u32 {
        core::ptr::null_mut() as *mut u32 //~ ptr_as_ptr
    }

    fn use_path() -> *const u32 {
        use std::ptr;
        ptr::null() as *const u32 //~ ptr_as_ptr
    }

    fn full_path() -> *const u32 {
        std::ptr::null() as *const u32 //~ ptr_as_ptr
    }
    ...
    fn full_core_path() -> *const u32 {
        core::ptr::null() as *const u32 //~ ptr_as_ptr
    }
}
...
mod null_ptr_infer {
    fn use_path_mut() -> *mut u32 {
        use std::ptr;
        ptr::null_mut() as *mut _ //~ ptr_as_ptr
    }

    fn full_path_mut() -> *mut u32 {
        std::ptr::null_mut() as *mut _ //~ ptr_as_ptr
    }
    ...
    fn full_core_path_mut() -> *mut u32 {
        core::ptr::null_mut() as *mut _ //~ ptr_as_ptr
    }

    fn use_path() -> *const u32 {
        use std::ptr;
        ptr::null() as *const _ //~ ptr_as_ptr
    }

    fn full_path() -> *const u32 {
        std::ptr::null() as *const _ //~ ptr_as_ptr
    }
    ...
    fn full_core_path() -> *const u32 {
        core::ptr::null() as *const _ //~ ptr_as_ptr
    }
}
...
mod null_entire_infer {
    fn use_path_mut() -> *mut u32 {
        use std::ptr;
        ptr::null_mut() as _ //~ ptr_as_ptr
    }

    fn full_path_mut() -> *mut u32 {
        std::ptr::null_mut() as _ //~ ptr_as_ptr
    }
    ...
    fn full_core_path_mut() -> *mut u32 {
        core::ptr::null_mut() as _ //~ ptr_as_ptr
    }

    fn use_path() -> *const u32 {
        use std::ptr;
        ptr::null() as _ //~ ptr_as_ptr
    }

    fn full_path() -> *const u32 {
        std::ptr::null() as _ //~ ptr_as_ptr
    }
