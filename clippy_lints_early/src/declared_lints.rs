...
pub static LINTS: &[&::declare_clippy_lint::LintInfo] = &[
    ...
    crate::misc::BUILTIN_TYPE_SHADOW_INFO,
    crate::misc::DUPLICATE_UNDERSCORE_ARGUMENT_INFO,
    crate::misc::MIXED_CASE_HEX_LITERALS_INFO,
    crate::misc::REDUNDANT_AT_REST_PATTERN_INFO,
    crate::misc::REDUNDANT_PATTERN_INFO,
    crate::misc::SEPARATED_LITERAL_SUFFIX_INFO,
    crate::misc::UNNEEDED_FIELD_PATTERN_INFO,
    crate::misc::UNNEEDED_WILDCARD_PATTERN_INFO,
    crate::misc::UNSEPARATED_LITERAL_SUFFIX_INFO,
    crate::misc::ZERO_PREFIXED_LITERAL_INFO,
