pub mod crosspointer_transmute;
pub mod eager_transmute;
pub mod missing_transmute_annotations;
pub mod transmute_int_to_bool;
pub mod transmute_int_to_non_zero;
pub mod transmute_null_to_fn;
pub mod transmute_ptr_to_ptr;
pub mod transmute_ptr_to_ref;
pub mod transmute_ref_to_ref;
pub mod transmute_undefined_repr;
pub mod transmutes_expressible_as_ptr_casts;
pub mod transmuting_null;
pub mod unsound_collection_transmute;
pub mod useless_transmute;
pub mod utils;
pub mod wrong_transmute;
