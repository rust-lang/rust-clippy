pub mod bind_instead_of_map;
pub mod by_ref_peekable_peek;
pub mod bytecount;
pub mod bytes_count_to_len;
pub mod bytes_nth;
pub mod case_sensitive_file_extension_comparisons;
pub mod chars_cmp;
pub mod chars_cmp_with_unwrap;
pub mod chars_last_cmp;
pub mod chars_last_cmp_with_unwrap;
pub mod chars_next_cmp;
pub mod chars_next_cmp_with_unwrap;
pub mod chunks_exact_to_as_chunks;
pub mod clear_with_drain;
pub mod clone_on_copy;
pub mod clone_on_ref_ptr;
pub mod cloned_instead_of_copied;
pub mod collapsible_str_replace;
pub mod double_ended_iterator_last;
pub mod drain_collect;
pub mod err_expect;
pub mod expect_fun_call;
pub mod extend_with_drain;
pub mod filetype_is_file;
pub mod filter_map;
pub mod filter_map_bool_then;
pub mod filter_map_identity;
pub mod filter_map_next;
pub mod filter_next;
pub mod flat_map_identity;
pub mod flat_map_option;
pub mod format_collect;
pub mod get_first;
pub mod get_last_with_len;
pub mod get_unwrap;
pub mod implicit_clone;
pub mod inefficient_to_string;
pub mod inspect_for_each;
pub mod into_iter_on_ref;
pub mod io_other_error;
pub mod ip_constant;
pub mod is_digit_ascii_radix;
pub mod is_empty;
pub mod iter_cloned_collect;
pub mod iter_count;
pub mod iter_filter;
pub mod iter_kv_map;
pub mod iter_next_slice;
pub mod iter_nth;
pub mod iter_nth_zero;
pub mod iter_on_single_or_empty_collections;
pub mod iter_out_of_bounds;
pub mod iter_overeager_cloned;
pub mod iter_skip_next;
pub mod iter_skip_zero;
pub mod iter_with_drain;
pub mod iterator_step_by_zero;
pub mod join_absolute_paths;
pub mod lines_filter_map_ok;
pub mod manual_c_str_literals;
pub mod manual_clear;
pub mod manual_contains;
pub mod manual_inspect;
pub mod manual_is_variant_and;
pub mod manual_next_back;
pub mod manual_ok_or;
pub mod manual_option_zip;
pub mod manual_repeat_n;
pub mod manual_saturating_arithmetic;
pub mod manual_str_repeat;
pub mod manual_try_fold;
pub mod map_all_any_identity;
pub mod map_clone;
pub mod map_collect_result_unit;
pub mod map_err_ignore;
pub mod map_flatten;
pub mod map_identity;
pub mod map_or_identity;
pub mod map_unwrap_or;
pub mod map_unwrap_or_else;
pub mod map_with_unused_argument_over_ranges;
pub mod mut_mutex_lock;
pub mod needless_as_bytes;
pub mod needless_character_iteration;
pub mod needless_collect;
pub mod needless_option_as_deref;
pub mod needless_option_take;
pub mod new_ret_no_self;
pub mod no_effect_replace;
pub mod obfuscated_if_else;
pub mod ok_expect;
pub mod open_options;
pub mod option_as_ref_cloned;
pub mod option_as_ref_deref;
pub mod option_map_or_none;
pub mod option_zip_none;
pub mod or_fun_call;
pub mod or_then_unwrap;
pub mod path_buf_push_overwrite;
pub mod path_ends_with_ext;
pub mod ptr_offset_by_literal;
pub mod ptr_offset_with_cast;
pub mod range_zip_with_len;
pub mod read_line_without_trim;
pub mod readonly_write_lock;
pub mod redundant_as_str;
pub mod repeat_once;
pub mod result_map_or_else_none;
pub mod return_and_then;
pub mod search_is_some;
pub mod seek_from_current;
pub mod seek_to_start_instead_of_rewind;
pub mod should_implement_trait;
pub mod single_char_add_str;
pub mod skip_while_next;
pub mod sliced_string_as_bytes;
pub mod some_filter;
pub mod stable_sort_primitive;
pub mod str_split;
pub mod str_splitn;
pub mod string_extend_chars;
pub mod string_lit_chars_any;
pub mod suspicious_command_arg_space;
pub mod suspicious_map;
pub mod suspicious_splitn;
pub mod suspicious_to_owned;
pub mod swap_with_temporary;
pub mod type_id_on_box;
pub mod unbuffered_bytes;
pub mod uninit_assumed_init;
pub mod unit_hash;
pub mod unnecessary_fallible_conversions;
pub mod unnecessary_filter_map;
pub mod unnecessary_first_then_check;
pub mod unnecessary_fold;
pub mod unnecessary_get_then_check;
pub mod unnecessary_iter_cloned;
pub mod unnecessary_join;
pub mod unnecessary_lazy_eval;
pub mod unnecessary_literal_unwrap;
pub mod unnecessary_map_or;
pub mod unnecessary_map_or_else;
pub mod unnecessary_min_or_max;
pub mod unnecessary_sort_by;
pub mod unnecessary_to_owned;
pub mod unnecessary_unwrap_unchecked;
pub mod unwrap_expect_used;
pub mod useless_asref;
pub mod useless_nonzero_new_unchecked;
pub mod vec_resize_to_zero;
pub mod verbose_file_reads;
pub mod waker_clone_wake;
pub mod wrong_self_convention;
pub mod zst_offset;
