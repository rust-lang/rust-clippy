...
use clippy_utils::{ReturnVisitor, path_res, visit_returns};
use rustc_ast::ast::LitKind;
use rustc_errors::Applicability;
use rustc_hir::def::Res;
use rustc_hir::intravisit::FnKind;
use rustc_hir::{Block, Body, Expr, ExprKind, FnDecl, FnRetTy, Lit, MutTy, Mutability, PrimTy, Ty, TyKind};
...
impl ReturnVisitor for LiteralReturnVisitor {
    ...
    fn visit_diverging_implicit_return(&mut self, _: &Block<'_>) -> Self::Result {
