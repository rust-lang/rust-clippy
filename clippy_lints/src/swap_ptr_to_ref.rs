            ...
            span_lint_and_then(
                ...
                |diag| {
                    if !((from_ptr1 && arg1_span.is_none()) || (from_ptr2 && arg2_span.is_none()))
                        && let Some(snip1) = arg1_span.unwrap_or(arg1.span).get_source_text_at_ctxt(cx, ctxt)
                        && let Some(snip2) = arg2_span.unwrap_or(arg2.span).get_source_text_at_ctxt(cx, ctxt)
                    {
