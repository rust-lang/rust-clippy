...
pub mod manual_filter;
pub mod manual_map;
pub mod manual_ok_err;
pub mod manual_unwrap_or;
pub mod manual_utils;
pub mod match_as_ref;
pub mod match_bool;
pub mod match_like_matches;
pub mod match_ref_pats;
pub mod match_same_arms;
pub mod match_single_binding;
pub mod match_str_case_mismatch;
pub mod match_wild_enum;
pub mod match_wild_err_arm;
pub mod needless_match;
pub mod overlapping_arms;
pub mod redundant_guards;
pub mod redundant_pattern_match;
pub mod rest_pat_in_fully_bound_struct;
pub mod significant_drop_in_scrutinee;
pub mod single_match;
pub mod try_err;
pub mod wild_in_or_pats;
