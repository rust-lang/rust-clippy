...
use rustc_hir::{Pat, PatExpr, PatExprKind, PatKind, RangeEnd};
...
impl<'a> NormalizedPat<'a> {
    pub(super) fn from_pat(cx: &LateContext<'_>, arena: &'a DroplessArena, pat: &'a Pat<'_>) -> Self {
        match pat.kind {
    ...
    /// type.
    pub(super) fn has_overlapping_values(&self, other: &Self) -> bool {
        match (*self, *other) {
