...
pub const CELL_REF: [&str; 3] = ["core", "cell", "Ref"];
pub const CELL_REFMUT: [&str; 3] = ["core", "cell", "RefMut"];
...
pub const SYNC_MUTEXGUARD: [&str; 4] = ["std", "sync", "mutex", "MutexGuard"];
pub const SYNC_RWLOCKREADGUARD: [&str; 4] = ["std", "sync", "rwlock", "RwLockReadGuard"];
pub const SYNC_RWLOCKWRITEGUARD: [&str; 4] = ["std", "sync", "rwlock", "RwLockWriteGuard"];
