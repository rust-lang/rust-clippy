pub mod char_indices_as_byte_indices;
pub mod empty_loop;
pub mod explicit_counter_loop;
pub mod explicit_into_iter_loop;
pub mod explicit_iter_loop;
pub mod for_kv_map;
pub mod for_unbounded_range;
pub mod infinite_loop;
pub mod iter_next_loop;
pub mod manual_find;
pub mod manual_flatten;
pub mod manual_memcpy;
pub mod manual_slice_fill;
pub mod manual_while_let_some;
pub mod missing_spin_loop;
pub mod mut_range_bound;
pub mod needless_range_loop;
pub mod never_loop;
pub mod same_item_push;
pub mod single_element_loop;
pub mod unused_enumerate_index;
pub mod while_float;
pub mod while_immutable_condition;
pub mod while_let_loop;
pub mod while_let_on_iterator;
