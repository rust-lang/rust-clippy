...
pub mod assign_op_pattern;
pub mod bit_mask;
pub mod cmp_owned;
pub mod const_comparisons;
pub mod decimal_bitwise_operands;
pub mod double_comparison;
pub mod duration_subsec;
pub mod eq_op;
pub mod erasing_op;
pub mod float_cmp;
pub mod float_equality_without_abs;
pub mod identity_op;
pub mod integer_division;
pub mod integer_division_remainder_used;
pub mod invalid_upcast_comparisons;
pub mod manual_div_ceil;
pub mod manual_is_multiple_of;
pub mod manual_isolate_lowest_one;
pub mod manual_midpoint;
pub mod misrefactored_assign_op;
pub mod modulo_arithmetic;
pub mod modulo_one;
pub mod needless_bitwise_bool;
pub mod numeric_arithmetic;
pub mod op_ref;
pub mod self_assignment;
pub mod verbose_bit_mask;
